            ...
            <div class="layout-content">
                ...
                <div class="order-header">
                    <div class="order-tabs">
                        <a href="" class="order-tabs__item active">Физ. лицо</a>
                        <a href="/orders/create-org" class="order-tabs__item">Юр. лицо</a>
                    </div>
                ...
                <div class="order-items">
                    ...
                    <div class="order-item">
                        <div class="order-item__title">Получатель товара</div>
                        <div class="columns">
                            ...
                            <div class="column col-6 md-col-12">
                                ...
                                ?>
                                <!-- <div class="input-group ">
                                    <div class="input-label required">Контактный телефон:</div>
                                    <input type="text" class="input">
                                </div> -->
                            </div>
                        </div>
                    ...
                    <div class="order-item">
                        ...
                        ?>
                        <!-- <div class="input-group">
                            <textarea class="input textarea" placeholder="Текст комментария..."></textarea>
                        </div> -->
                    </div>
