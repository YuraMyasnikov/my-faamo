...
<script>
    const TOTAL_PRICE = <?= Html::encode(Yii::$app->basket->totalPrice()); ?>
</script>
                ...
                <div class="order__tabs">
                    <?php if (Yii::$app->user->isGuest) { ?>
                        <div class="enter-block">
                            ...
                            <a href="<?= Url::to(['/login']); ?>" class="enter-block__link">Авторизироваться</a>
                        </div>
                    <?php } ?>
                    <div class="tabs">
                        <div class="tabs-nav">
                            <a class="tabs-nav__item active" href="<?= Url::to(['/orders/create']); ?>">Физ. лицо</a>
                            <a class="tabs-nav__item" href="<?= Url::to(['/orders/create-org']); ?>">Юр. лицо</a>
                        </div>
                    </div>
                    ...
                    <div class="tabs-content">
                        <div class="tab-page">
                            ...
                            <h2 class="reg-form__title">Получатель товара</h2>
                    ...
                    <div class="order-summary">
                        ...
                        <div class="cart-summary__list">
                            ...
                            <div class="cart-summary__row">
                                ...
                                <div class="cart-summary__row-value"><span id="discount_value">0</span> <span class="icon-rub"></span></div>
                            </div>
                        </div>
                        <div class="cart-summary__row cart-result">
                            <div class="cart-result__title">Итого: </div>
                            <div class="cart-result__value"><span id="total_price"><?= Html::encode(Yii::$app->basket->totalPrice()) ?></span> <span class="icon-rub"></span></div>
