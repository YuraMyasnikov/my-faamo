...
<div class="popup-bg popup appointment-popup" role="alert">
    <div class="popup-bx-center">
        ...
        <?php $form = ActiveForm::begin(['action' => BookcallForm::FORM_ACTION, 'method' => 'post']); ?>
        <?= $form->field($bookcallForm,
            'fio',
            ['options' => ['class' => 'popup-form-item']])->textInput(); ?>
        <?= $form->field($bookcallForm, 'phone', ['options' => ['class' => 'popup-form-item']])->widget(MaskedInput::class, ['mask' => '+7 (999) 999-99-99']) ?>
        <?php
